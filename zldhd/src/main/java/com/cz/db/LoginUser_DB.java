...
public class LoginUser_DB extends SQLiteOpenHelper {

    private final static String TAG = "LoginUser_DB";

    public static final String CREATE_TEBLE = "create table tcc_user(account text,password text,ip text,login_time text,out_time text)";
    ...
    // TODO: 下面是默认构造方法
    public LoginUser_DB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
