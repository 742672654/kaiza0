...
public class BaseSQL_DB extends SQLiteOpenHelper {
    ...
    public static BaseSQL_DB baseSQL_DB;
...
class static_SQL{
     ...
     static final String CREATE_TEBLE3 = "create table user( account text,password text,logontime text,qr text, role text,iscancel text,notemsg text,mobile text,cname text,nfc text,token text,authflag text, etc text,swipe text,name text,isshowepay text,comid text,state text,info text,uptime text)";
