        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Constant.COMECAR_MSG: //65
                    ...
                    break;
                case Constant.SHOWVIDEO_MSG: //60
                    callbackBitmap(msg);
                    break;
...
//			int resType = mBundle.getInt("resType");// 资源类型
			...
			FileUtil.writeSDFile("入场抬杆流程", "我的车牌号:"+carPlate);
            ...
            try {
                ...
                //如果是预约的订单，订单已经存在了
//                if(mBundle.getInt("order_type")>0){
//
//                    return ;
//                }

                if (resType == 8 || resType==2 ) {
...
//		zldNewActivity = ZldNewActivity.getInstance();
    ...
    private void initGetInfo(Bundle extras) {
        ...
        Log.v("HomeExitPageService","comid是"+comid);
